...
import popController from "../controllers/popController.js";
import payment2Controller from "../controllers/payment2Controller.js";
...
import cldMinimalController from "../controllers/cldMinimalController.js";
...
const initWebRouter = (app) => {
  ...
  // CLD provider (seamless launch + provider callback)
router.get(
  "/cld/game_link",
  middlewareController,
  cldMinimalController.getGameLink
);

// provider → our server callback (no auth middleware)
router.post(
  "/provider/callback/cld",
  cldMinimalController.providerCallback
);
  ...
  router.get("/coming-soon",middlewareController, homeController.comeingsooon);
  router.get("/games",middlewareController, homeController.games);
  ...
  router.get("/activity", middlewareController, homeController.activityPage);
   router.get("/earn-money", middlewareController, homeController.earn_moneyPage);
  router.get("/dailytask", middlewareController, homeController.dailytaskPage);
    router.get("/viprewards", middlewareController, homeController.viprewards);
      router.get("/slotmachineweekly", middlewareController, homeController.slotmachineweekly);
      
      
          router.get("/earnmoney", middlewareController, homeController.earnmoney);
      router.get("/slotmachineextra", middlewareController, homeController.slotmachineextra);
  router.get(
    "/invitation_rules",
    middlewareController,
  ...
  router.get(
   ...
   router.post(
   "/api/webapi/payment/top/withdrawNotify",
    withdrawalController.withdrawaltoppaynotify,
  );
  router.get(
  ...
  router.post("/wallet/verify/cloudpay", paymentController.verifyCloudpayPayment );
  ...
  router.get("/aviator", middlewareController, userController.aviator);
    ...
    router.get(
    "/api/webapi/appsetting",
    homeController.appsetting,
  ); // get info account
  ...
  router.post(
   ...
   router.post(
    "/api/webapi/admin/withdraw/top",
    // adminController.middlewareAdminController,
    withdrawalController.sendToLGPay,
  ); // register
 ...
 router.get(
  ...
  router.get(
    ...
    router.get(
    "/admin/manager/usdt/settings",
    adminController.middlewareAdminController,
    adminController.usdt,
  ); // get info account

router.post(
  "/api/webapi/payment/webpay",
  payment2Controller.webpay
);



router.post(
  "/api/webapi/payment/lg-pay",
  payment2Controller.lg_pay
);



router.post(
  "/api/webapi/payment/top/notify",
  payment2Controller.topnotify
);


router.post(
  "/api/webapi/payment/lg/notify",
  payment2Controller.lgnotify
);


router.get("/usdt/wepay", payment2Controller.usedpage);

router.post(
  "/api/webapi/admin/approveRecharge",
  adminController.middlewareAdminController,
  payment2Controller.approveRecharge
);
...
// ✅ Admin routes for USDT settings
router.post(
  "/manager/usdt/update",
  adminController.middlewareAdminController, // Auth check
  upload.single("usdt_qr_code"),             // Multer handles image upload
  payment2Controller.updateUsdtSettings         // Controller updates DB
);

router.get(
  "/api/webapi/usdt/getUsdtSettings",
//   adminController.middlewareAdminController,
  payment2Controller.getUsdtSettings
);

router.post(
  "/api/webapi/usdt/submit",
  // adminController.middlewareAdminController, // optional
  payment2Controller.addManualUSDTPaymentRequest
);
  ...
  router.get("/api/webapi/slider", sliderController.getBanners);
router.post(
  "/api/webapi/slider/create",
  withdrawalRateLimiter,
  middlewareController,
  upload.single("image"),      // ← handle file upload
  sliderController.createBanner
);

router.delete(
  "/api/webapi/slider/:id",
  withdrawalRateLimiter,
  middlewareController,
  sliderController.deleteBanner
);
...
router.get("/api/webapi/pop", popController.getPops);
...
router.post(
  ...
  popController.createPop
);
router.put("/api/webapi/pop/:id", upload.single("image"), popController.updatePop);
router.delete(
  "/api/webapi/pop/:id",
  withdrawalRateLimiter,
  middlewareController,
  popController.deletePop
);
...
router.get(
  ...
  router.post(
    ...
    router.post(
    "/nexx/balance",
    newgameController.nexxBalance,
  );
  
    router.post(
    "/nexx/credit",
    newgameController.nexxCredit,
  );
  
    router.post(
    "/nexx/debit",
    newgameController.nexxDebit,
  );
    ...
    router.get("/admin/manager/user", adminController.createUserPage); 
  router.post("/api/webapi/create-user", accountController.createUserForAdmin); 
  ...
  router.get(
    ...
    router.get("/api/admin/fetch-dashboard-data", dashboardData);
