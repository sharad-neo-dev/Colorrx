...
const addWinGo = async (game) => {
  try {
    ...
    let NewGamePeriod =null;
    if(game == 30 ){
        NewGamePeriod= generatePeriod30Sec(gameRepresentationId);
        
    }else{
    NewGamePeriod=  generatePeriod(gameRepresentationId);
    }
