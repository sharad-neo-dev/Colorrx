...
const games = async (req, res) => {
  try {
    ...
    return res.render("games.ejs", { providerCode, gameCode, currency });
  } catch (error) {
...
const slotmachineweekly = async (req, res) => {
  return res.render("promotion/slot-machine-weekly.ejs");
};
const earn_moneyPage = async (req, res) => {
  return res.render("checkIn/earnmoney.ejs");
};
